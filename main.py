...
#player
playerSurface = pygame.image.load("graphics/1.png").convert_alpha()
playerSurface2 = pygame.image.load("graphics/2.png").convert_alpha()
...
#intro screen
playerStand = pygame.image.load("graphics/try.png").convert_alpha()
